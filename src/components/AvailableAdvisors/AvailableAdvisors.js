        ...
        <div className="advisor__card">
          ...
          <div className="advisor__card--wrapper">
            ...
            <div className="advisor__card--wrapper">
              ...
              <div className="advisor__paragraph">
                "My goals to help my clients manage and grow their wealth.
                During my work ours, I'm always online to chat with my clients!"
              </div>
            </div>
          </div>
          ...
          <div className="advisor__card">
            ...
            <div className="advisor__card--wrapper">
              ...
              <div className="advisor__paragraph">
                "I aspire to help my clients build a retirment plan that is
                tailored for heir needs."
              </div>
            </div>
          </div>
        </div>
